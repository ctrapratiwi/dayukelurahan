...
<body>
	<div class="container-fluid">
    	...
    	<div class="row info">
        	...
        	<div class="col-lg-12">
                <div class="box">
                <h4>Input Data Kasus Covid-19 (Bali)</h4>
                @if (session('alert'))
                ...
                @endif
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="dirawat" >
                      </div>
         	...
         	<div class="row text col-lg-12">
                <div class="col-lg-6">@Udayana University</div>
                <div class="col-lg-6 text-right">Peta Sebaran Covid-19 (Bali) 2020</div>
        	</div>
