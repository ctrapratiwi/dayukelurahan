...
<title>Peta Sebaran Covid Prov Bali 2020</title>
...
<div class="container-fluid">
	<div class="row header">
		...
		<div class="col-lg-10 judul text-left">
    		<h2>Peta Sebaran Covid-19 Bali</h2>
       	</div>
    ...
    <div class="row info2">
    	Data Sebaran Kasus Covid-19 Bali
    </div>
    ...
    <div class="row info">
        ...
        <div class="row info">
                <div class="box col-lg-2">
                    ...
                    <img src="/image/Logo/positif.JPG" />
                </div>


                <div class="box col-lg-2">
                    <h5 class="title3">Dirawat</h5>
                    <p>Jumlah :</p>
                    <h3>{{$totalDirawat[0]->dirawat}} Orang</h3><br />
                    <img src="/image/Logo/dirawat-di-ruang-isolasi.png" />
                </div>
            	...
            	<div class="box col-lg-2">
                    ...
                    <img src="/image/Logo/3people.jpg" />
                </div>
    			...
    			<div class="box col-lg-2">
                    ...
                    <img src="/image/Logo/orang.jpg" />
                </div>

        	<div class="card" style="width: 80rem;">

              <div class="card-body">
                    <h5 class="card-title">Peta Sebaran Kasus Covid-19 Bali</h5>
              </div>
    	...
    	<div class="row text col-lg-12">
            ...
            <div class="col-lg-6 text-right">Peta Sebaran Covid-19 Prov Bali 2020</div>
        </div>
        ...
        onKMZLoaded: function (kmz_layer, name) {
          ...
          var layers = kmz_layer.getLayers()[0].getLayers();
            ...
            var kab  = layer.feature.properties.NAME_2;
                ...
                var BIRU_MUDA = {opacity:'1',color:'#000',fillOpacity:'1', fillColor:'#3358ff'};
                var BIRU_TUA = {opacity:'1',color:'#000',fillOpacity:'1', fillColor:'#0000a6'};
                var ORANGE = {opacity:'1',color:'#000',fillOpacity:'1', fillColor:'#ff8d03'};
                var UNGU_MUDA = {opacity:'1',color:'#000',fillOpacity:'1', fillColor:'#cd87ff'};
                var UNGU_TUA = {opacity:'1',color:'#000',fillOpacity:'1', fillColor:'#9500ff'};
                  ...
                  // layer.setStyle(STYLE);
                    ...
                    if(!Array.isArray(searchResult) || !searchResult.length ==0){
                      ...
                      if(item.total == 0 ){
                        ...
                        layer.setStyle(UNGU_MUDA);
                      }else{
                        layer.setStyle(UNGU_TUA);
                      }
